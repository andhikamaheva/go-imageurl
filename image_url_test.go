...
func TestGetFileName(t *testing.T) {
	...
	fileName := SetURI("https://dummyimage.com/600x400/000/fff.jpg")

	is.Equal("fff.jpg", fileName.GetFileName())
}

func TestJPGImage(t *testing.T) {
	is := is.New(t)

	imageType := SetURI("https://dummyimage.com/600x400/000/fff.jpg")

	is.Equal("jpg", imageType.GetImageType())
}
